...
### 2. <a name="jp4">Semantic HTML</a>  [:arrow_up:](#jp0)
...
### 3. <a name="jp5">Separation of presentation and content</a>  [:arrow_up:](#jp0)
...
### 4. <a name="jp6">Meta element</a>  [:arrow_up:](#jp0)
...
*[HTML meta tags from w3cschool:](http://www.w3school.com.cn/tags/tag_meta.asp){:target="_blank"}*
...
### 5. <a name="jp7">Document type declaration</a>  [:arrow_up:](#jp0)
